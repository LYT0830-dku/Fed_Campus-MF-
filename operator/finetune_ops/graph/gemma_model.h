...
/**
 * @brief Text-only Gemma3 270M config (aligned with HuggingFace Gemma3TextConfig)
 */
...
public:
    ...
    // Alignment debugging: enable/disable intermediate activation dumps
    ...
    // Numeric gradient perturbation control (debug only)
